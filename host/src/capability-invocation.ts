...
const FEATURE_MANIFEST: CapabilityInvocationFeatureManifest = deepFreeze({
  ...
  guarantees: {
    ...
    "root-bound-repository-read": "active",
    "private-write-roots": "active",
    "no-fork": "active",
    "payload-cpu": "active",
    "payload-memory": "active",
    "payload-children": "active",
  ...
  domains: {
    ...
    "environment.scoped-tree-runner": "active",
    credentials: "active",
    git: "unsupported",
    ipc: "unsupported",
    devices: "unsupported",
  ...
  operations: {
    ...
    "filesystem.write.private-regular": "active",
    "filesystem.create.private-regular": "active",
